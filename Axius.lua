...
function AxiusAssets()
if scriptfolder:FindFirstChild("AxiusAssets") then return end

local Folder=i("Folder",scriptfolder)
Folder.Name="AxiusAssets"
...
if not scriptfolder:FindFirstChild("AxiusAssets") then 
--Folder:Destroy()
f:Disconnect()
--PosRoot(0)
end
