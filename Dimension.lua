...
if (t>0 and t<=33.5) or t>167.2 then
local p=rgb(0,0,0)
local s=rgb(0,45,59)
li.Brightness=2+sound.PlaybackLoudness/30
li.Range=2+sound.PlaybackLoudness/15
li.Color=s
for _,c in foldah:GetDescendants() do
if c:IsA("ParticleEmitter") then 
--c.LightEmission=1
c.Brightness=1+g*1.75
--c.LightInfluence=1+g*1.2
c.Color=cs({
  csk(0,p),
  csk(1,s),
})
...
elseif t>=33.5 and t<=50.25 then 
local p=rgb(0,0,0)
local s=rgb(22,93,115)
li.Brightness=2+sound.PlaybackLoudness/30
li.Range=2+sound.PlaybackLoudness/15
li.Color=s
for _,c in foldah:GetDescendants() do
...
elseif t>=50.25 and t<=66.1 then 
local p=rgb(0,0,0)
local s=rgb(64,205,248)
li.Brightness=2+sound.PlaybackLoudness/30
li.Range=2+sound.PlaybackLoudness/15
li.Color=s
for _,c in foldah:GetDescendants() do
...
elseif t>=67.1 and t<=83.8 then 
local p=rgb(0,0,0)
local s=rgb(97,188,215)
li.Brightness=2+sound.PlaybackLoudness/30
li.Range=2+sound.PlaybackLoudness/15
li.Color=s
for _,c in foldah:GetDescendants() do
...
elseif t>=83.8 and t<=116.85 then 
local p=rgb(0,0,0)
local s=rgb(22,93,115)
li.Brightness=2+sound.PlaybackLoudness/30
li.Range=2+sound.PlaybackLoudness/15
...
elseif t>=116.85 and t<=133.25 then 
local p=rgb(0,0,0)
local s=rgb(19,49,58)
li.Brightness=2+sound.PlaybackLoudness/30
li.Range=2+sound.PlaybackLoudness/15
li.Color=s
for _,c in foldah:GetDescendants() do
...
elseif t>=133.25 and t<=133.85 then 
local p=rgb(0,0,0)
local s=rgb(0,0,0)
li.Brightness=2+sound.PlaybackLoudness/30
li.Range=2+sound.PlaybackLoudness/15
...
elseif t>133.85 and t<=149.1 then 
local p=rgb(0,0,0)
local s=rgb(102,191,218)
li.Brightness=2+sound.PlaybackLoudness/30
li.Range=2+sound.PlaybackLoudness/15
li.Color=s
for _,c in foldah:GetDescendants() do
...
elseif t>149.2 and t<=150.2 then 
local p=rgb(0,0,0)
local s=rgb(0,0,0)
li.Brightness=2+sound.PlaybackLoudness/30
li.Range=2+sound.PlaybackLoudness/15
...
elseif t>150.1 and t<=167.2 then 
local p=rgb(0,0,0)
local s=rgb(96,196,237)
li.Brightness=2+sound.PlaybackLoudness/30
li.Range=2+sound.PlaybackLoudness/15
li.Color=s
for _,c in foldah:GetDescendants() do
...
repeat Dimension() task.wait() until not scriptfolder:FindFirstChild(Name.."Assets")
