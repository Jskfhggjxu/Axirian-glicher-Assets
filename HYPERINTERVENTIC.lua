...
local spin=1
local hhh=nil
hhhh=PostSimulation:Connect(function()
...
sphere1("Out",2.5,v3(.5,.5,.5),v3(hhh*5,.5,.5),f.CFrame*cf(0,0,0),scolor.Value,0,f.CFrame*cf(0,0,0),true,pcolor.Value,false,50)
else
...
repeat VFX1() task.wait() until not scriptfolder:FindFirstChild(Name.."Assets")
