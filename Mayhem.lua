...
if scriptfolder:FindFirstChild("MayhemAssets") then return end 
local foldhh=i("Folder",scriptfolder)
foldhh.Name="MayhemAssets"
...
if not scriptfolder:FindFirstChild("MayhemAssets") then 
fuh:Disconnect() 
end 
rotate+=1
...
v.Color=cs({
  csk(0,rgb(224+sound.PlaybackLoudness/150,0,0)),
  csk(1,rgb(224+sound.PlaybackLoudness/150,0,0))
})
end
end
...
v.Color=rgb(224+sound.PlaybackLoudness/150,0,0)
