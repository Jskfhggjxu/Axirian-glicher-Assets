...
--Nholiviction
function NholivictionAssets()
if scriptfolder:FindFirstChild("NholivictionAssets") then return end

local foldah=i("Folder",scriptfolder)
foldah.Name="NholivictionAssets"
...
repeat NholivictionAssets() task.wait() until not scriptfolder:FindFirstChild("NholivictionAssets") 
